    ...
    return (
        <section className="w-full py-4">
            <div className="mt-2 grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 max-w-7xl mx-auto">
                <Link href={"/perwako-bakeuda-pangkalpinang/details/perwako/2024"} className="hover:scale-105">
                    <div className={StyleBox}>
                        <Image src={perwako24} alt="perwako-2024" fill quality={100} placeholder='blur' />
                    </div>
                </Link>
                <Link href={"/perwako-bakeuda-pangkalpinang/details/perwako/2023"} className="hover:scale-105">
                    <div className={StyleBox}>
                        <Image src={perwako23} alt="perwako-2023" fill quality={100} placeholder='blur' />
                    </div>
                </Link>
                <Link href={"/perwako-bakeuda-pangkalpinang/details/perwako/2022"} className="hover:scale-105">
                    <div className={StyleBox}>
                        <Image src={perwako22} alt="perwako-2022" fill quality={100} placeholder='blur' />
                    </div>
                </Link>
                <Link href={"/perwako-bakeuda-pangkalpinang/details/perwako/2021"} className="hover:scale-105">
                    <div className={StyleBox}>
                        <Image src={perwako21} alt="perwako-2021" fill quality={100} placeholder='blur' />
                    </div>
                </Link>
                <Link href={"/perwako-bakeuda-pangkalpinang/details/perwako/2020"} className="hover:scale-105">
                    <div className={StyleBox}>
