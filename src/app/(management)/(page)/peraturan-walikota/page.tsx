...
const useGetDokuments = async () => {
    const res = await getDocuments("perwako");
...
export default function PerwakoPage() {
        ...
        if (confirm) {
            try {
                ...
                if (response.status === true) {
                    ...
                    queryClient.invalidateQueries({ queryKey: ["dokumen-perwako"] });
                } else {
    ...
    const handleEdit = async (id: string) => {
        router.push(`/document/edit/peraturan-walikota/${id}`);
    };
    const handleDetail = async (id: string) => {
        router.push(`/document/detail/peraturan-walikota/${id}`);
    };
    ...
    return (
        <div className="p-4">
            ...
            <Button
                ...
                onClick={() => {
                    router.push("document/add/peraturan-walikota");
                }}
            >
