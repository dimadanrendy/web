...
export default function EditPegawai({ params }: { params: { slug1: string; slug2: string } }) {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            const response = await getUsersById(params.slug2);
    ...
    return (
        <div>
            <div>
                <Link href={`/daftar-pegawai/all/${params.slug1}`}>
