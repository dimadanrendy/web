...
export default function PageCarouselSeputarInformasiTwo() {
    const [pageSlider, setPageSlider] = React.useState(2);
    ...
    const { data: DataBeritaSlider, isLoading: LoadingBeritaSlider } = useQuery({
        queryKey: ["berita", "seputar-informasi", pageSlider],
        queryFn: async () => {
            return await getBeritaByTipe("seputar-informasi", pageSlider, pageSize);
        },
    });
